...
<head>
  ...
  <style>
    ...
    :root {
      ...
      --accent:    #6272ff;
      --accent2:   #6fe3ff;
      --accent-glow: rgba(98,114,255,.18);
      --green:     #16c784;
      --green2:    #79f0c0;
      --red:       #ff5e74;
      --red2:      #ff92a2;
      ...
      --shadow-lg: 0 20px 56px rgba(0,0,0,.28);
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body {
      background:
        radial-gradient(circle at top left, rgba(98,114,255,.13), transparent 26%),
        radial-gradient(circle at top right, rgba(0,213,216,.09), transparent 24%),
        linear-gradient(180deg, #060b12 0%, #07101a 100%);
      color: var(--text);
    ...
    .nav-logo {
      ...
      background: linear-gradient(135deg, var(--accent2), #ffffff 45%, var(--accent));
    ...
    .sidebar {
      ...
      background: linear-gradient(180deg, rgba(11,18,27,.96), rgba(10,17,25,.92));
    ...
    .source-item:hover { background: rgba(255,255,255,.04); border-color: var(--border2); }
    .source-item.on {
    ...
    .source-item.off {
      background: rgba(255,94,116,.04);
      border-color: rgba(255,94,116,.12);
      color: var(--dim);
      opacity: .7;
    }
    ...
    /* ── Main content ── */
    .main { flex: 1; min-width: 0; padding: 24px 24px 28px; }

    /* ── Stats grid ── */
    .stats-row { display: grid; grid-template-columns: repeat(auto-fit, minmax(170px, 1fr)); gap: 14px; margin-bottom: 28px; }
    .stat-card {
      background: linear-gradient(180deg, rgba(255,255,255,.025), rgba(255,255,255,.01)); border: 1px solid var(--border);
    ...
    .stat-card:hover { border-color: rgba(98,114,255,.34); transform: translateY(-2px); box-shadow: 0 18px 44px rgba(0,0,0,.28); }
    .stat-card::before {
    ...
    .toolbar {
      ...
      padding: 14px 18px;
      background: linear-gradient(180deg, rgba(255,255,255,.025), rgba(255,255,255,.01)); border: 1px solid var(--border); border-radius: 16px;
      backdrop-filter: blur(8px);
      box-shadow: var(--shadow);
    }
    ...
    /* ── Control Panel ── */
    .control-panel {
      background: linear-gradient(135deg, rgba(98,114,255,.08) 0%, rgba(0,213,216,.03) 100%);
      border: 1px solid rgba(98,114,255,.16);
    ...
    .control-btn:hover {
      border-color: rgba(98,114,255,.34);
      background: rgba(98,114,255,.08);
    ...
    .btn-primary {
      ...
      color: #fff; box-shadow: 0 10px 28px rgba(98,114,255,.3);
    }
    .btn-primary:hover { box-shadow: 0 16px 32px rgba(98,114,255,.34); transform: translateY(-1px); }
    .btn-primary:active { transform: translateY(0); }
    .btn-ghost {
      background: rgba(255,255,255,.025); border: 1px solid var(--border2);
      color: var(--muted);
    }
    .btn-ghost:hover { background: rgba(255,255,255,.05); color: var(--text); border-color: var(--border3); }
    ...
    .sidebar-settings-btn:hover { background: rgba(255,255,255,.05); color: var(--text); }
    .sidebar-settings-btn.active { background: rgba(98,114,255,.14); color: var(--accent2); border: 1px solid rgba(98,114,255,.22); }
